...
export const copy = {
  ar: {
    ...
    nav: { home: "الرئيسية", marketplace: "السوق", reels: "الريلز", pricing: "الباقات", about: "عن المنصة", contact: "تواصل معنا", login: "دخول", dashboard: "لوحة التاجر" },
  ...
  en: {
    ...
    nav: { home: "Home", marketplace: "Marketplace", reels: "Reels", pricing: "Plans", about: "About", contact: "Contact", login: "Sign in", dashboard: "Merchant dashboard" },
