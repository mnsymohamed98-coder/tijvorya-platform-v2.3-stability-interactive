...
export const copy = {
  ar: {
    ...
    nav: { home: "الرئيسية", marketplace: "السوق", reels: "الريلز", about: "عن المنصة", contact: "تواصل معنا", login: "دخول", dashboard: "لوحة التاجر" },
  ...
  en: {
    ...
    nav: { home: "Home", marketplace: "Marketplace", reels: "Reels", about: "About", contact: "Contact", login: "Sign in", dashboard: "Merchant dashboard" },
